...
const About = () => {
    return (
        <div
            id="about"
            className="w-[90%] m-auto min-h-screen pt-20 items-center flex flex-col text-xs sm:text-[16px]"
        >
            <div
                className="max-w-[1240px] w-full flex-1 mx-auto flex flex-col justify-center items-center about-container mb-4 sm:mb-20"
                data-aos="fade-right"
                ...
                <div className="flex flex-col w-full">
                    ...
                    <div className="flex flex-row about-container-1">
                        <div className="flex flex-col about-countainer">
                            <img
                                className="animated-image mb-3 w-24 h-24 block sm:hidden rounded-full ring-2 ring-[#67E8F9]/20 shadow-lg shadow-[#ffffff] hover:shadow-[#67E8F9] mx-auto hover:scale-110 ease-in duration-200"
                                src={profile}
                                alt="/"
                            />
                            <p className="mt-3 pb-0 sm:pb-2 text-gray-200 leading-4 sm:leading-6 about-text-1">
                            ...
                            <p className="mt-2 sm:mt-4 text-gray-200 leading-4 sm:leading-6 about-text-2">
                            ...
                            <p className="mt-2 sm:mt-4 text-gray-200 leading-4 sm:leading-6 about-text-3">
