...
const ProjectType = (props) => {
    ...
    return (
        <div
            id={props.projectId}
            className="w-full items-center flex flex-col project-type"
        >
            <div
            ...
            <SideScroller
                ...
                iconSize={48}
                navLinkToBack={props.navLinkToBack}
                toLeft={true}
                classProp={
                    'flex-row hidden 2xl:flex absolute top-[50%] left-[1%] cursor-pointer hover:text-[#67E8F9]'
                }
            />
            <SideScroller
                AOSAnchor={props.AOSAnchor}
                ...
                iconSize={48}
                navLinkToBack={props.navLinkToNext}
                toLeft={false}
                classProp={
                    'flex-row hidden 2xl:flex absolute top-[50%] right-[1%] cursor-pointer hover:text-[#67E8F9]'
                }
            />
            <div className="max-w-[1240px] mx-auto px-6 pt-6 flex flex-col project-type-contain">
                {' '}
                {/* lg:grid-cols-5 */}
